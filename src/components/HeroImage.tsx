...
const HeroImage = () => {
  return (
    <div className="relative">
      ...
      <div className="relative bg-white/5 backdrop-blur-sm rounded-lg shadow-xl overflow-hidden animate-float">
        {/* Main card */}
        <Card className="bg-white shadow-lg w-full">
          <div className="flex flex-col p-6 gap-4">
            ...
            {/* Chart */}
            <div className="h-40 bg-blue-50 rounded-md relative overflow-hidden mt-2">
        ...
        {/* Side cards - positioned absolutely */}
        
        {/* Inventory card - left */}
        <div className="absolute left-[-100px] top-1/2 transform -translate-y-1/2">
          <Card className="bg-white shadow-lg w-[180px]">
            <div className="p-4">
        ...
        {/* Schedule card - right */}
        <div className="absolute right-[-80px] top-1/4">
          <Card className="bg-white shadow-lg w-[160px]">
            <div className="p-4">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 bg-blue-100 rounded-md flex items-center justify-center">
